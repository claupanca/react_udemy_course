...
// we configure this route to refetch data once per day
  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2">
        <Image
          // images that we can statically impoort
          // images that are on the local machine
          src={about1}
      ...
      <div className="col-span-2 relative aspect-square">
        <Image
          // images that are not imported
          // we have to use the relative, astept-square and object-cover
          // technique
          src="/about-2.jpg"
          fill
